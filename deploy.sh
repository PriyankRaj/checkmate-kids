#!/usr/bin/env bash
# Deploy Checkmate Kids to the Play Store and/or App Store Connect.
#
# Usage:
...
# csquest. If it hasn't been granted access to this app (com.priyank.checkmate_kids) in Play
...
IOS_BUNDLE_ID="com.priyank.checkmateKids"
